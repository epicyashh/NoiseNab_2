...
import { Volume2, MapPin, FileInput, Map, Menu, X } from "lucide-react";
    ...
    <p>
      ...
      <strong>Your participation matters!</strong> Join us in shaping a more peaceful urban future.  
          ...
          <div className="hero-buttons">
            ...
            <a href={`${DJANGO_URL}/data`} className="secondary-button">
              <Map size={20} />
              Explore Noise Map
            </a>
            <Link to="/hotspot-map" className="primary-button">
              <Map size={20} />
              Noise Hotspot Map
            </Link>
          </div>
